...
public class JSON_test {
	...
	private static final String JSON_FILE = "jsonTest2.json";
	...
	public static void main(String[] args) {
		...
		try {
			...
			//				InputStream is = 
			//		                JSON_test.class.getResourceAsStream(JSON_FILE);

			InputStream is = new FileInputStream("adjacencyList.json");
